...
export default function CarCard(props:any) {
  ...
  return (
    <div
      className="group bg-slate-800 p-2 sm:p-5 rounded-3xl m-1 sm:m-5
hover:bg-slate-700 
...
border-cyan-500 shadow-2xl"
    >
      ...
      <div className="flex justify-around group-hover:hidden">
        ...
        <div className="text-center text-gray-500">
          ...
          <h2 className="line-clamp-5 text-[14px] font-light">5 Seat</h2>
        </div>
        <div className=" text-center text-gray-500 ">
    ...
    p-2 rounded-lg text-white w-full px-5 justify-between"
      >
        Rent Now
        <span className="bg-cyan-400 p-1 rounded-md ">
          <svg
